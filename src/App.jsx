...
const INIT_NODES = [
  ...
  // ── Буровые станки ──
  { id:"a1", parentId:"c1", name:"Kaishan KG-920B", type:"ASSET", catType:null, fuelRate:16.7, desc:"Буровой станок марки Kaishan KG 920B с компрессором Sanrock SR 550-17, серийный номер 19081701  101", assigned_object_id:null, createdBy:"system", createdAt:now },
  ...
  { id:"a3", parentId:"c1", name:"Kaishan-103", type:"ASSET", catType:null, fuelRate:16.7, desc:"Kaishan -103", assigned_object_id:null, createdBy:"system", createdAt:now },
  ...
  { id:"a5", parentId:"c1", name:"JK-105", type:"ASSET", catType:null, fuelRate:16.7, desc:"Гидравлическая буровая установка JK590 Шасси № JK2202566 Двигатель № D7FG4N00146  105", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"a6", parentId:"c1", name:"JK-106", type:"ASSET", catType:null, fuelRate:16.7, desc:"Гидравлическая буровая установка JK590 Шасси № JK2302079L Двигатель № D7FG4N00247   106", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"a7", parentId:"c1", name:"ROC-107", type:"ASSET", catType:null, fuelRate:16.7, desc:"Буровая установка SANROCK R68  107", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"a8", parentId:"c1", name:"ROC-108", type:"ASSET", catType:null, fuelRate:16.7, desc:"Буровая установка SANROCK R68  108", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"a9", parentId:"c1", name:"JK-109", type:"ASSET", catType:null, fuelRate:16.7, desc:"Гидравлическая буровая установка JK590 Шасси № JK2202561 Двигатель № D7FG4N00141  109", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"a10", parentId:"c1", name:"JK-110", type:"ASSET", catType:null, fuelRate:16.7, desc:"Гидравлическая буровая установка JK590 (номер серийный JK2302253L)  110", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"a11", parentId:"c1", name:"JK-111", type:"ASSET", catType:null, fuelRate:16.7, desc:"Гидравлическая буровая установка JK590BC-2A (номер серийный JK2502202L) JK111", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"a12", parentId:"c1", name:"JK-112", type:"ASSET", catType:null, fuelRate:16.7, desc:"Гидравлическая буровая установка JK590BC-2A  Шасси № JK2502083L   JK 112", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"a13", parentId:"c1", name:"JK-113", type:"ASSET", catType:null, fuelRate:16.7, desc:"Гидравлическая буровая установка JK590BC-2A  (номер серийнsй JK2502197L) JK113", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"a14", parentId:"c1", name:"JK-114", type:"ASSET", catType:null, fuelRate:16.7, desc:"Гидравлическая буровая установка JK590BC-2A  (номер серийный JK2502208L)  JK114", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"a15", parentId:"c1", name:"JK-115", type:"ASSET", catType:null, fuelRate:16.7, desc:"Гидравлическая буровая установка JK590BC-2A  (номер серийный JK2502207L)  JK115", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"a16", parentId:"c1", name:"JK-116", type:"ASSET", catType:null, fuelRate:16.7, desc:"Гидравлическая буровая установка JK590BC-2A  (номер серийный JK2502200L)  JK116", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"a18", parentId:"c1", name:"Zega-117", type:"ASSET", catType:null, fuelRate:16.7, desc:"Буровая установка ZEGA D545H Бактай  118", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"a17", parentId:"c1", name:"JK-118", type:"ASSET", catType:null, fuelRate:16.7, desc:"Гидравлическая буровая установка JK590BC-2A  (номер серийный JK2502198L)  JK117", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"a19", parentId:"c1", name:"JK-119", type:"ASSET", catType:null, fuelRate:16.7, desc:"JK - 119", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"a20", parentId:"c1", name:"JK-120", type:"ASSET", catType:null, fuelRate:16.7, desc:"JK - 120", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"a21", parentId:"c1", name:"JK-121", type:"ASSET", catType:null, fuelRate:16.7, desc:"JK - 121", assigned_object_id:null, createdBy:"system", createdAt:now },
  // ── Компрессоры ──
  { id:"ax201", parentId:"c7", name:"Компрессор-201", type:"ASSET", catType:null, fuelRate:30.0, desc:"", assigned_object_id:null, createdBy:"system", createdAt:now },
  ...
  { id:"ax203", parentId:"c7", name:"SR550-203", type:"ASSET", catType:null, fuelRate:30.0, desc:"ВОЗДУШНЫЙ КОМПРЕССОР SR550-17", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"ax204", parentId:"c7", name:"Компрессор-204", type:"ASSET", catType:null, fuelRate:30.0, desc:"", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"ax205", parentId:"c7", name:"Компрессор-205", type:"ASSET", catType:null, fuelRate:30.0, desc:"", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"ax206", parentId:"c7", name:"LGCY-18/17-206", type:"ASSET", catType:null, fuelRate:30.0, desc:"Компрессор винтовой LGCY-18/17 производительностью 18м3/мин  206", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"ax207", parentId:"c7", name:"LUY180-207", type:"ASSET", catType:null, fuelRate:29.0, desc:"Воздушный компрессор LUY180-19  207", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"ax208", parentId:"c7", name:"LUY180-208", type:"ASSET", catType:null, fuelRate:29.0, desc:"Воздушный компрессор LUY180-19  208", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"ax209", parentId:"c7", name:"LGCY17/18-18/15T-209", type:"ASSET", catType:null, fuelRate:29.0, desc:"КОМПРЕССОР LGCY17/18-18/15T  2   209", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"ax210", parentId:"c7", name:"LGCY17/18-18/15T-210", type:"ASSET", catType:null, fuelRate:29.0, desc:"КОМПРЕССОР LGCY17/18-18/15T  210", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"ax211", parentId:"c7", name:"LGCY17/18-18/15T-211", type:"ASSET", catType:null, fuelRate:29.0, desc:"КОМПРЕССОР LGCY17/18-18/15T  211", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"ax212", parentId:"c7", name:"LGCY17/18-18/15T-212", type:"ASSET", catType:null, fuelRate:29.0, desc:"КОМПРЕССОР LGCY17/18-18/15T  1  212", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"ax213", parentId:"c7", name:"LGCY17/18-18/15T-213", type:"ASSET", catType:null, fuelRate:29.0, desc:"КОМПРЕССОР LGCY17/18-18/15T  3  213", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"ax214", parentId:"c7", name:"LGCY17/18-18/15T-214", type:"ASSET", catType:null, fuelRate:29.0, desc:"КОМПРЕССОР LGCY17/18-18/15T  214", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"ax215", parentId:"c7", name:"LGCY17/18-18/15T-215", type:"ASSET", catType:null, fuelRate:29.0, desc:"КОМПРЕССОР LGCY17/18-18/15T серийный 17182508010А  215", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"ax216", parentId:"c7", name:"LGCY17/18-18/15T-216", type:"ASSET", catType:null, fuelRate:29.0, desc:"КОМПРЕССОР LGCY17/18-18/15T серийный 17182508002А   216", assigned_object_id:null, createdBy:"system", createdAt:now },
  // ── СЗМ ──
  ...
  { id:"ax302", parentId:"c2", name:"СЗМ-HOWO", type:"ASSET", catType:null, fuelRate:33.0, desc:"HOWO", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"ax303", parentId:"c2", name:"СЗМ-Mercedes", type:"ASSET", catType:null, fuelRate:33.0, desc:"Mercedes -Benz", assigned_object_id:null, createdBy:"system", createdAt:now },
  ...
  // ── Лёгкие авто ──
  { id:"ax501", parentId:"c4", name:"NiSSAN-501", type:"ASSET", catType:null, fuelRate:13.0, desc:"NiSSAN PICK­UP", assigned_object_id:null, createdBy:"system", createdAt:now },
  ...
  { id:"ax503", parentId:"c4", name:"Toyota-503", type:"ASSET", catType:null, fuelRate:12.0, desc:"Toyota Hilux SURF", assigned_object_id:null, createdBy:"system", createdAt:now },
  ...
  { id:"ax506", parentId:"c4", name:"Toyota-506", type:"ASSET", catType:null, fuelRate:13.0, desc:"Toyota Hilux", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"ax507", parentId:"c4", name:"NiSSAN-507", type:"ASSET", catType:null, fuelRate:13.0, desc:"NiSSAN PICK­UP", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"ax508", parentId:"c4", name:"Toyota-508", type:"ASSET", catType:null, fuelRate:13.0, desc:"Toyota Hilux", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"ax509", parentId:"c4", name:"Toyota-509", type:"ASSET", catType:null, fuelRate:13.0, desc:"Toyota Hilux", assigned_object_id:null, createdBy:"system", createdAt:now },
  ...
  { id:"ax511", parentId:"c4", name:"Toyota-511", type:"ASSET", catType:null, fuelRate:13.0, desc:"Toyota Hilux Pick Up", assigned_object_id:null, createdBy:"system", createdAt:now },
  // ── Грузовые/прицепы ──
  { id:"ax401", parentId:"c5", name:"ПАЗ-401", type:"ASSET", catType:null, fuelRate:14.0, desc:"ПАЗ", assigned_object_id:null, createdBy:"system", createdAt:now },
  ...
  { id:"ax406", parentId:"c5", name:"КАМАЗ-406", type:"ASSET", catType:null, fuelRate:33.0, desc:"КАМАЗ 55102", assigned_object_id:null, createdBy:"system", createdAt:now },
  ...
  { id:"ax703", parentId:"c8", name:"LONKING-703", type:"ASSET", catType:null, fuelRate:120.0, desc:"ГУСЕНИЧНЫЙ ЭКСКАВАТОР LONKING CDM6336 (Гидромолот) , VIN: LSW306E3VS0013508", assigned_object_id:null, createdBy:"system", createdAt:now },
  { id:"ax704", parentId:"c8", name:"Погрузчик-704", type:"ASSET", catType:null, fuelRate:70.0, desc:"Погрузчик Мамонт", assigned_object_id:null, createdBy:"system", createdAt:now },
];
...
const INIT_PASSPORTS = {
  // ── Буровые станки ──
  a1: { assetClass:"DRILL_RIG", manufacturer:"Kaishan", model:"KG 920B", serial:"19081701", year:null, inventory:"№101", reg_plate:"", engine_vol:null, commissioned:"2019-01-01", total_hours:null, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  a2: { assetClass:"DRILL_RIG", manufacturer:"Kaishan", model:null, serial:"", year:null, inventory:"№102", reg_plate:"", engine_vol:null, commissioned:"2022-05-01", total_hours:null, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}], maintNote:"Ремонт гидромотора — 336000 тг" },
  a3: { assetClass:"DRILL_RIG", manufacturer:"Kaishan", model:null, serial:"", year:null, inventory:"№103", reg_plate:"", engine_vol:null, commissioned:"2022-10-17", total_hours:null, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  a4: { assetClass:"DRILL_RIG", manufacturer:null, model:"KG-590", serial:"", year:null, inventory:"№104", reg_plate:"", engine_vol:null, commissioned:"2024-01-10", total_hours:null, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  a5: { assetClass:"DRILL_RIG", manufacturer:"JK Boart", model:"JK590", serial:"AJ2300306", year:"2023", inventory:"№105", reg_plate:"", engine_vol:null, commissioned:"2024-04-04", total_hours:null, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}], maintNote:"Капитальный ремонт двигателья — 828 175 тг" },
  a6: { assetClass:"DRILL_RIG", manufacturer:"JK Boart", model:"JK590", serial:"AJ2300302", year:"2023", inventory:"№106", reg_plate:"", engine_vol:null, commissioned:"2024-04-04", total_hours:null, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  a7: { assetClass:"DRILL_RIG", manufacturer:"Sanrock", model:"R68", serial:"", year:null, inventory:"№107", reg_plate:"", engine_vol:null, commissioned:"2025-05-05", total_hours:null, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  a8: { assetClass:"DRILL_RIG", manufacturer:"Sanrock", model:"R68", serial:"", year:null, inventory:"№108", reg_plate:"", engine_vol:null, commissioned:"2025-05-05", total_hours:null, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  a9: { assetClass:"DRILL_RIG", manufacturer:"JK Boart", model:"JK590", serial:"", year:"2023", inventory:"№109", reg_plate:"", engine_vol:null, commissioned:"2024-08-01", total_hours:null, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  a10: { assetClass:"DRILL_RIG", manufacturer:"JK Boart", model:"JK590", serial:"JK2302253L", year:"2023", inventory:"№110", reg_plate:"", engine_vol:null, commissioned:"2024-08-01", total_hours:6245, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  a11: { assetClass:"DRILL_RIG", manufacturer:"JK Boart", model:"JK590BC", serial:"SNA2500301", year:"2025", inventory:"№111", reg_plate:"", engine_vol:null, commissioned:"2025-08-13", total_hours:2343, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  a12: { assetClass:"DRILL_RIG", manufacturer:"JK Boart", model:"JK590BC", serial:"AJ2501004", year:"2025", inventory:"№112", reg_plate:"", engine_vol:null, commissioned:"2025-08-22", total_hours:2157, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  a13: { assetClass:"DRILL_RIG", manufacturer:"JK Boart", model:"JK590BC", serial:"SNA2500301", year:"2025", inventory:"№113", reg_plate:"", engine_vol:null, commissioned:"2025-08-22", total_hours:2414, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  a14: { assetClass:"DRILL_RIG", manufacturer:"JK Boart", model:"JK590BC", serial:"SNA2500301", year:"2025", inventory:"№114", reg_plate:"", engine_vol:null, commissioned:"2025-08-22", total_hours:null, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  a15: { assetClass:"DRILL_RIG", manufacturer:"JK Boart", model:"JK590BC", serial:"SNA2500312", year:"2025", inventory:"№115", reg_plate:"", engine_vol:null, commissioned:"2025-09-10", total_hours:2062, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  a16: { assetClass:"DRILL_RIG", manufacturer:"JK Boart", model:"JK590BC", serial:"SNA2500311", year:"2025", inventory:"№116", reg_plate:"", engine_vol:null, commissioned:"2025-09-10", total_hours:null, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  a18: { assetClass:"DRILL_RIG", manufacturer:"Zega", model:"D545H", serial:"", year:"2025", inventory:"№117", reg_plate:"", engine_vol:null, commissioned:null, total_hours:null, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  a17: { assetClass:"DRILL_RIG", manufacturer:"JK Boart", model:"JK590BC", serial:"SNA2500307", year:"2025", inventory:"№118", reg_plate:"", engine_vol:null, commissioned:"2025-12-18", total_hours:712, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  a19: { assetClass:"DRILL_RIG", manufacturer:"JK Boart", model:null, serial:"AY250403", year:"2026", inventory:"№119", reg_plate:"", engine_vol:null, commissioned:"2026-01-01", total_hours:null, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  a20: { assetClass:"DRILL_RIG", manufacturer:"JK Boart", model:null, serial:"AY250404", year:"2026", inventory:"№120", reg_plate:"", engine_vol:null, commissioned:"2026-01-01", total_hours:null, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  a21: { assetClass:"DRILL_RIG", manufacturer:"JK Boart", model:null, serial:"AY250401", year:"2026", inventory:"№121", reg_plate:"", engine_vol:null, commissioned:"2026-01-01", total_hours:null, fuel_rate:16.7, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  // ── Компрессоры ──
  ax201: { assetClass:"COMPRESSOR", manufacturer:null, model:null, serial:"", year:null, inventory:"№201", reg_plate:"", engine_vol:null, commissioned:null, total_hours:null, fuel_rate:30.0, toSchedule:[{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:3000,duration_hrs:48}] },
  ax202: { assetClass:"COMPRESSOR", manufacturer:"Sanrock", model:"SR550-17", serial:"", year:null, inventory:"№202", reg_plate:"", engine_vol:null, commissioned:"2022-05-06", total_hours:null, fuel_rate:30.0, toSchedule:[{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:3000,duration_hrs:48}] },
  ax203: { assetClass:"COMPRESSOR", manufacturer:"Sanrock", model:"SR550-17", serial:"", year:null, inventory:"№203", reg_plate:"", engine_vol:null, commissioned:"2022-10-17", total_hours:null, fuel_rate:30.0, toSchedule:[{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:3000,duration_hrs:48}] },
  ax204: { assetClass:"COMPRESSOR", manufacturer:null, model:null, serial:"", year:null, inventory:"№204", reg_plate:"", engine_vol:null, commissioned:null, total_hours:null, fuel_rate:30.0, toSchedule:[{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:3000,duration_hrs:48}], maintNote:"Капитальный ремонт двигателья — 172 2325 тг" },
  ax205: { assetClass:"COMPRESSOR", manufacturer:null, model:null, serial:"", year:null, inventory:"№205", reg_plate:"", engine_vol:null, commissioned:null, total_hours:null, fuel_rate:30.0, toSchedule:[{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:3000,duration_hrs:48}] },
  ax206: { assetClass:"COMPRESSOR", manufacturer:"LGCY", model:"LGCY-18/17", serial:"", year:null, inventory:"№206", reg_plate:"", engine_vol:null, commissioned:"2024-01-10", total_hours:null, fuel_rate:30.0, toSchedule:[{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:3000,duration_hrs:48}], maintNote:"Капитальный ремонт двигателья — 133 4725 тг" },
  ax207: { assetClass:"COMPRESSOR", manufacturer:"LiuGong", model:"LUY180-19", serial:"", year:null, inventory:"№207", reg_plate:"", engine_vol:null, commissioned:"2025-05-05", total_hours:null, fuel_rate:29.0, toSchedule:[{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:3000,duration_hrs:48}] },
  ax208: { assetClass:"COMPRESSOR", manufacturer:"LiuGong", model:"LUY180-19", serial:"", year:null, inventory:"№208", reg_plate:"", engine_vol:null, commissioned:"2025-05-05", total_hours:6372, fuel_rate:29.0, toSchedule:[{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:3000,duration_hrs:48}], maintNote:"Капитальный ремонт двигателья — 129 9800 тг" },
  ax209: { assetClass:"COMPRESSOR", manufacturer:"LGCY", model:"LGCY17/18-18/15T", serial:"", year:null, inventory:"№209", reg_plate:"", engine_vol:null, commissioned:"2025-04-10", total_hours:3149, fuel_rate:29.0, toSchedule:[{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:3000,duration_hrs:48}], maintNote:"Капитальный ремонт двигателья — 113 7605 тг" },
  ax210: { assetClass:"COMPRESSOR", manufacturer:"LGCY", model:"LGCY17/18-18/15T", serial:"", year:null, inventory:"№210", reg_plate:"", engine_vol:null, commissioned:"2025-11-08", total_hours:null, fuel_rate:29.0, toSchedule:[{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:3000,duration_hrs:48}] },
  ax211: { assetClass:"COMPRESSOR", manufacturer:"LGCY", model:"LGCY17/18-18/15T", serial:"", year:null, inventory:"№211", reg_plate:"", engine_vol:null, commissioned:"2025-11-08", total_hours:null, fuel_rate:29.0, toSchedule:[{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:3000,duration_hrs:48}] },
  ax212: { assetClass:"COMPRESSOR", manufacturer:"LGCY", model:"LGCY17/18-18/15T", serial:"", year:null, inventory:"№212", reg_plate:"", engine_vol:null, commissioned:"2025-04-10", total_hours:null, fuel_rate:29.0, toSchedule:[{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:3000,duration_hrs:48}] },
  ax213: { assetClass:"COMPRESSOR", manufacturer:"LGCY", model:"LGCY17/18-18/15T", serial:"", year:null, inventory:"№213", reg_plate:"", engine_vol:null, commissioned:"2025-04-10", total_hours:1813, fuel_rate:29.0, toSchedule:[{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:3000,duration_hrs:48}] },
  ax214: { assetClass:"COMPRESSOR", manufacturer:"LGCY", model:"LGCY17/18-18/15T", serial:"", year:null, inventory:"№214", reg_plate:"", engine_vol:null, commissioned:"2025-11-25", total_hours:null, fuel_rate:29.0, toSchedule:[{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:3000,duration_hrs:48}], maintNote:"Капитальный ремонт двигателья — 108 7285 тг" },
  ax215: { assetClass:"COMPRESSOR", manufacturer:"LGCY", model:"LGCY17/18-18/15T", serial:"17182508010", year:null, inventory:"№215", reg_plate:"", engine_vol:null, commissioned:"2025-12-31", total_hours:null, fuel_rate:29.0, toSchedule:[{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:3000,duration_hrs:48}] },
  ax216: { assetClass:"COMPRESSOR", manufacturer:"LGCY", model:"LGCY17/18-18/15T", serial:"17182508002", year:null, inventory:"№216", reg_plate:"", engine_vol:null, commissioned:"2025-12-31", total_hours:null, fuel_rate:29.0, toSchedule:[{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:3000,duration_hrs:48}] },
  // ── СЗМ ──
  ax301: { assetClass:"SZM", manufacturer:null, model:null, serial:"MI00000664", year:"2006", inventory:"№301", reg_plate:"633 BG 09", engine_vol:11760, commissioned:"2021-01-13", total_hours:null, fuel_rate:33.0, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}], maintNote:"Замена автошины шт2 — 156000 тг за одну шт" },
  ax302: { assetClass:"SZM", manufacturer:null, model:null, serial:"MI99997820", year:"2017", inventory:"№302", reg_plate:"601 AQ 09", engine_vol:9726, commissioned:"2023-08-08", total_hours:null, fuel_rate:33.0, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  ax303: { assetClass:"SZM", manufacturer:null, model:null, serial:"MI99883348", year:"2014", inventory:"№303", reg_plate:"346 BJ 09", engine_vol:6374, commissioned:"2025-03-12", total_hours:null, fuel_rate:33.0, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  ax304: { assetClass:"SZM", manufacturer:null, model:null, serial:"MI00005465", year:"2004", inventory:"№304", reg_plate:"369 AI 09", engine_vol:14860, commissioned:"2022-06-17", total_hours:null, fuel_rate:null, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:2},{name:"ТО-500",interval:500,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:8},{name:"Капремонт",interval:5000,duration_hrs:72}] },
  // ── Лёгкие авто ──
  ax501: { assetClass:"CAR", manufacturer:null, model:null, serial:"MF06993403", year:"1999", inventory:"№501", reg_plate:"175 BR 09", engine_vol:2500, commissioned:"2024-04-02", total_hours:null, fuel_rate:13.0, toSchedule:[{name:"ТО-10000км",interval:10000,duration_hrs:4},{name:"ТО-50000км",interval:50000,duration_hrs:16}] },
  ax502: { assetClass:"CAR", manufacturer:null, model:null, serial:"MQ99975430", year:"2014", inventory:"№502", reg_plate:"346 AQV 09", engine_vol:2982, commissioned:"2024-08-22", total_hours:null, fuel_rate:13.0, toSchedule:[{name:"ТО-10000км",interval:10000,duration_hrs:4},{name:"ТО-50000км",interval:50000,duration_hrs:16}] },
  ax503: { assetClass:"CAR", manufacturer:null, model:null, serial:"AK99919098", year:"1993", inventory:"№503", reg_plate:"732 BH 09", engine_vol:2440, commissioned:"2024-09-10", total_hours:null, fuel_rate:12.0, toSchedule:[{name:"ТО-10000км",interval:10000,duration_hrs:4},{name:"ТО-50000км",interval:50000,duration_hrs:16}] },
  ax504: { assetClass:"CAR", manufacturer:null, model:null, serial:"MW99999928", year:"2006", inventory:"№504", reg_plate:"010 ZZ 09", engine_vol:4664, commissioned:"2024-10-09", total_hours:null, fuel_rate:30.0, toSchedule:[{name:"ТО-10000км",interval:10000,duration_hrs:4},{name:"ТО-50000км",interval:50000,duration_hrs:16}] },
  ax505: { assetClass:"CAR", manufacturer:null, model:null, serial:"MI99884935", year:"2012", inventory:"№505", reg_plate:"090 ES 09", engine_vol:5663, commissioned:"2024-10-31", total_hours:null, fuel_rate:20.0, toSchedule:[{name:"ТО-10000км",interval:10000,duration_hrs:4},{name:"ТО-50000км",interval:50000,duration_hrs:16}] },
  ax506: { assetClass:"CAR", manufacturer:null, model:null, serial:"YA99801193", year:"2007", inventory:"№506", reg_plate:"104 APJ 09", engine_vol:2492, commissioned:"2024-11-16", total_hours:null, fuel_rate:13.0, toSchedule:[{name:"ТО-10000км",interval:10000,duration_hrs:4},{name:"ТО-50000км",interval:50000,duration_hrs:16}] },
  ax507: { assetClass:"CAR", manufacturer:null, model:null, serial:"KF00000066", year:"2005", inventory:"№507", reg_plate:"350 AJ 09", engine_vol:3000, commissioned:"2022-12-01", total_hours:null, fuel_rate:13.0, toSchedule:[{name:"ТО-10000км",interval:10000,duration_hrs:4},{name:"ТО-50000км",interval:50000,duration_hrs:16}] },
  ax508: { assetClass:"CAR", manufacturer:null, model:null, serial:"HY99801326", year:"2010", inventory:"№508", reg_plate:"746 BQ 09", engine_vol:2500, commissioned:"2025-01-16", total_hours:null, fuel_rate:13.0, toSchedule:[{name:"ТО-10000км",interval:10000,duration_hrs:4},{name:"ТО-50000км",interval:50000,duration_hrs:16}] },
  ax509: { assetClass:"CAR", manufacturer:null, model:null, serial:"MJ99777832", year:"2006", inventory:"№509", reg_plate:"175 ATB 09", engine_vol:2500, commissioned:"2025-01-17", total_hours:null, fuel_rate:13.0, toSchedule:[{name:"ТО-10000км",interval:10000,duration_hrs:4},{name:"ТО-50000км",interval:50000,duration_hrs:16}] },
  ax510: { assetClass:"CAR", manufacturer:null, model:null, serial:"MI99880610", year:"2025", inventory:"№510", reg_plate:"850 BQ 09", engine_vol:1997, commissioned:"2025-11-06", total_hours:null, fuel_rate:null, toSchedule:[{name:"ТО-10000км",interval:10000,duration_hrs:4},{name:"ТО-50000км",interval:50000,duration_hrs:16}] },
  ax511: { assetClass:"CAR", manufacturer:null, model:null, serial:"MI99879636", year:"2013", inventory:"№511", reg_plate:"135 BT 09", engine_vol:2500, commissioned:"2026-01-24", total_hours:null, fuel_rate:13.0, toSchedule:[{name:"ТО-10000км",interval:10000,duration_hrs:4},{name:"ТО-50000км",interval:50000,duration_hrs:16}] },
  // ── Грузовые/прицепы ──
  ax401: { assetClass:"TRUCK", manufacturer:null, model:null, serial:"MI99880429", year:"2007", inventory:"№401", reg_plate:"145 BR 09", engine_vol:4750, commissioned:"2025-11-21", total_hours:3150, fuel_rate:14.0, toSchedule:[{name:"ТО-10000км",interval:10000,duration_hrs:4},{name:"ТО-50000км",interval:50000,duration_hrs:16}], maintNote:"Ремонт двигателя капитальный ремонт. Замена автошины шт2 — шины цена 78000 тг." },
  ax402: { assetClass:"TRUCK", manufacturer:null, model:null, serial:"MI00000252", year:"1995", inventory:"№402", reg_plate:"457 AZ 09", engine_vol:11967, commissioned:"2022-07-12", total_hours:null, fuel_rate:25.0, toSchedule:[{name:"ТО-10000км",interval:10000,duration_hrs:4},{name:"ТО-50000км",interval:50000,duration_hrs:16}] },
  ax403: { assetClass:"TRUCK", manufacturer:null, model:null, serial:"MJ00109239", year:"2007", inventory:"№403", reg_plate:"047 AEL 09", engine_vol:2464, commissioned:"2022-07-12", total_hours:null, fuel_rate:15.0, toSchedule:[{name:"ТО-10000км",interval:10000,duration_hrs:4},{name:"ТО-50000км",interval:50000,duration_hrs:16}] },
  ax404: { assetClass:"TRUCK", manufacturer:null, model:null, serial:"AL99882370", year:"2024", inventory:"№404", reg_plate:"P028402", engine_vol:8500, commissioned:"2024-11-01", total_hours:59081, fuel_rate:15.0, toSchedule:[{name:"ТО-10000км",interval:10000,duration_hrs:4},{name:"ТО-50000км",interval:50000,duration_hrs:16}] },
  ax405: { assetClass:"TRUCK", manufacturer:null, model:null, serial:"MJ99794019", year:"2023", inventory:"№405", reg_plate:"833 BQ 09", engine_vol:10520, commissioned:"2024-11-06", total_hours:null, fuel_rate:35.0, toSchedule:[{name:"ТО-10000км",interval:10000,duration_hrs:4},{name:"ТО-50000км",interval:50000,duration_hrs:16}] },
  ...
  ax703: { assetClass:"SPECIAL", manufacturer:"Lonking", model:"CDM6336", serial:"ASAY250710", year:"2025", inventory:"№703", reg_plate:"", engine_vol:null, commissioned:"2025-07-01", total_hours:null, fuel_rate:120.0, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:16}] },
  ax704: { assetClass:"SPECIAL", manufacturer:null, model:null, serial:"", year:"2025", inventory:"№704", reg_plate:"", engine_vol:null, commissioned:null, total_hours:null, fuel_rate:70.0, toSchedule:[{name:"ТО-250",interval:250,duration_hrs:4},{name:"ТО-1000",interval:1000,duration_hrs:16}] },
};
